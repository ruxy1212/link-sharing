    ...
    return (
        <section className="w-full bg-[#FAFAFA] rounded-[12px] p-5 flex justify-between items-center gap-4 flex-wrap md:flex-nowrap">
            ...
            <div className="flex gap-6 flex-wrap md:flex-nowrap w-full md:w-1/2 lg:w-7/12 items-center">
              <label
                  className={`${set?'text-dl-white':'text-[#633CFF]'} flex-shrink-0 gap-[8px] w-[193px] h-[193px] bg-[#EFEBFF] rounded-[12px] cursor-pointer flex flex-col justify-center items-center font-[var(--font)] text-[1rem] font-semibold leading-[150%] bg-cover bg-center bg-no-repeat`}
                  htmlFor='inputFile'
