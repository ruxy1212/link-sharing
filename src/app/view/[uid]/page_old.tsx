...
export async function generateMetadata({ params }: MetadataProps, parent: ResolvingMetadata): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: `${appUrl}/view/${uid}/og?firstName=${profile.firstName}&lastName=${profile.lastName}&userId=${uid}`,
          width: 1200,
          height: 630,
          ...
          <>
            ...
            <main className="flex justify-center items-center">
              <section className="relative top-7 sm:-top-24 lg:-top-36 bg-dl-white shadow-none md:shadow-xl w-full max-w-[349px] rounded-3xl p-0 sm:pt-6 pb-12 md:py-12 md:px-14 flex flex-col items-center">
                ...
                <a href={"mailto:"+profile?.email} className="font-normal hover:font-bold mb-[56px]"><h2 className="email text-dl-dark-gray font-sans text-base leading-[150%]">
