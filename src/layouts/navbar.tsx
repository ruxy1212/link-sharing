...
import MenuWithDropdown from '@/components/menu-width-dropdown'
...
const NavBar: React.FC<NavBarProps> = ({ currentTab, setCurrentTab, uid, setUid, setCustomPopupMessage, setOpenCustomPopup }) => {
  ...
  return (
    <header className="flex flex-col items-center w-full p-0 sm:p-4 md:px-6 md:py-4 lg:py-6">
      <nav className="w-full bg-dl-white rounded-xl flex justify-between items-center gap-6 p-4">
        ...
        <ul className="links hidden md:flex">
          <li>
            <button
              className={`px-6 md:px-7 py-3 whitespace-nowrap rounded-lg flex items-center text-dl-dark-gray font-sans text-base font-semibold leading-[150%] cursor-pointer justify-center gap-2 ${currentTab == 'links' ? 'text-dl-purple bg-dl-neutral-white border border-dl-purple' : 'text-dl-dark-gray'} hover:text-dl-purple`}
              onClick={handleLink}
              data-link="links"
            >
              <svg
          ...
          <li>
            <button
              className={`px-6 md:px-7 py-3 whitespace-nowrap rounded-lg flex items-center text-dl-dark-gray font-sans text-base font-semibold leading-[150%] cursor-pointer justify-center gap-2 ${currentTab == 'profile' ? 'text-dl-purple bg-dl-neutral-white border border-dl-purple' : 'text-dl-dark-gray'} hover:text-dl-purple`}
              onClick={handleLink}
              data-link="profile"
            >
              <svg
      ...
      <ul className="links flex bg-dl-white p-3 pt-0 notch md:hidden">
          <li>
            <button
              className={`px-4 py-2 sm:px-6 md:px-7 md:py-3 whitespace-nowrap rounded-lg flex items-center text-dl-dark-gray font-sans text-base font-semibold leading-[150%] cursor-pointer justify-center gap-2 ${currentTab == 'links' ? 'text-dl-purple bg-dl-neutral-white border border-dl-purple' : 'text-dl-dark-gray'} hover:text-dl-purple`}
              onClick={handleLink}
              data-link="links"
            >
              <svg
          ...
          <li>
            <button
              className={`px-4 py-2 sm:px-6 md:px-7 md:py-3 whitespace-nowrap rounded-lg flex items-center text-dl-dark-gray font-sans text-base font-semibold leading-[150%] cursor-pointer justify-center gap-2 ${currentTab == 'profile' ? 'text-dl-purple bg-dl-neutral-white border border-dl-purple' : 'text-dl-dark-gray'} hover:text-dl-purple`}
              onClick={handleLink}
              data-link="profile"
            >
              <svg
